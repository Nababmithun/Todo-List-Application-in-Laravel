    ...
    <AppLayout>
      ...
      <div className="max-w-md mx-auto bg-slate-800/70 rounded-2xl shadow p-4">
        ...
        <form className="space-y-3" onSubmit={submit}>
          ...
          <button className="w-full rounded-lg px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white">Create Account</button>
        </form>
        <p className="mt-3 text-sm">Already have an account? <Link href="/login" className="text-blue-400">Login</Link></p>
      </div>
    </AppLayout>
  );
}
